...
const slides = [
  {
    ...
    subtitle: "Connecting owner-operators with the best loads across the country.",
    cta: "Get Started",
    link: "/services",
  },
  {
    ...
    subtitle: "We handle the paperwork and logistics so you can focus on driving.",
    cta: "Our Pricing",
    link: "/plans",
  },
  {
    ...
    <div className="relative w-full h-[100vh] overflow-hidden group">
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          />
          {/* Overlay */}
          <div className="absolute inset-0 bg-black/50 bg-gradient-to-t from-black/70 via-black/20 to-transparent" />
